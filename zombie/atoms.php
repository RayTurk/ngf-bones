...
<?php 
    $args = array (
        ...
        'hero-image' => 'https://neongoldfish.com/wp-content/uploads/2019/12/space_hero.jpg',
    );
    /**
...
<!--[if gt IE 8]><!--> <html class="no-js" <?php language_attributes(); ?>> <!--<![endif]-->
    ...
    <body <?php body_class(); ?>>
        <style>
            ...
            .sg_info h1, .sg_info h2, .sg_info h3 {
                color: red;
            }
            .sg_info small {
                font-size: .5em;
        ...
        <div class="sg_info"><div class="container"><div class="title">The Style Guide</div><h1>Site Headers</h1><h2>Default Header: <small>get_atomic_part('organisms/header.php', 0)</small></h2></div></div>
        <?php get_atomic_part('organisms/header.php', 0);?>
        <div class="sg_info"><div class="container"><h2>Mini Header: <small>get_atomic_part('organisms/header-mini.php', 0)</small></h2></div></div>
        <?php get_atomic_part('organisms/header-mini.php', 0);?>
        <div id="content" class="styleguide_page">
           <div class="sg_info"><div class="container"><h1>Secondary Page Titles:</h1><h2>Default Page Title:<small>('molecules/page_title.php', $args)</small></h2></div></div>
            <?php get_atomic_part ('molecules/page_title.php', $args);?>
            <div class="sg_info"><div class="container"><h2>Line Page Title: <small>get_atomic_part ('molecules/page_title-line.php', $args)</small></h2></div></div>
            <?php get_atomic_part ('molecules/page_title-line.php', $args);?>
            <div class="sg_info"><div class="container"><h1>Secondary Page Titles:</h1><h2>Main Template Sample</h2></div></div>
            <div class="container main-content">
              ...
              an inline text link pretending to be a button (class="btn")
...
<br>
        ...
        <div class="sg_info"><div class="container"><h1>Site Footers</h1><h2>Default Footer (two column)<small>get_atomic_part('/organisms/footer.php', 0)</small></h2></div></div>
        
        <?php get_atomic_part('/organisms/footer.php', 0);?>
        <div class="sg_info"><div class="container"><h2>Four Column Footer <small>get_atomic_part('/organisms/footer-four_column.php', 0)</small></h2></div></div>
        <?php get_atomic_part('/organisms/footer-four_column.php', 0);?>
