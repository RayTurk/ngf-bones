...
function labnolIframe() {
    ...
    e.setAttribute("src", "https://www.youtube.com/embed/ID?autoplay=1&mute=0&rel=0".replace("ID", this.dataset.id)),
...
$(document).ready(function () {
        $(".navbar-nav>li.dropdown>a").on("click", function (e) {
            ...
            $("body").on("click", function (e) {
                $(".navbar").is(e.target) || 0 !== $(".navbar").has(e.target).length || 0 !== $(".navbar").has(e.target).length || $(".navbar.flyout .navbar-collapse").removeClass("show");
                $("li.dropdown").is(e.target) || 0 !== $("li.dropdown").has(e.target).length || 0 !== $(".open").has(e.target).length || $("li").removeClass("open");
            });
    }),
//pagebuilder universal jQuery
